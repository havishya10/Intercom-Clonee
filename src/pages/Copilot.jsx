...
export function Copilot() {
    ...
    return (
        <div className={"flex h-full  flex-col justify-between  bg-gradient-to-b from-white via-[#fff7f0] via-40% via-[#f9f0ff] via-70% to-[#fffde7] to-90%"}>
            ...
            <div
                className="p-2 my-2 mx-2 my-4 shadow-md border border-gray-200 rounded-xl focus-within:ring-2 focus-within:ring-purple-100 focus-within:border-violet-200 transition-all duration-200 bg-gradient-to-r from-pink-50 via-purple-0 to-indigo-50">
